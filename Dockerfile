...
# ComfyUI + requirements + frontend stable + Manager natif
RUN git clone --depth=1 https://github.com/comfyanonymous/ComfyUI.git /opt/ComfyUI \
 ...
 && /venv/bin/pip install --no-cache-dir -r /opt/ComfyUI/manager_requirements.txt
...
ENV ENABLE_JUPYTER=true \
    ...
    COMFY_PORT=8188 \
    COMFY_ARGS="--listen 0.0.0.0 --port 8188 --enable-manager --enable-manager-legacy-ui" \
    COMFY_ARGS_EXTRA="" \
